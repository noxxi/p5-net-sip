...
if HANDLE is readable (B<RW> 0) or writeable (B<RW> 1).
...
If B<RW> is 0 no more checking for readability of B<HANDLE> will be done.
If B<RW> is 1 no more checking for writeability of B<HANDLE> will be done.
